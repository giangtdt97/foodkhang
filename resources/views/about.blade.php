                                ...
                                <div class="main-slider">
                                    <div class="slides">
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2000</span></div><img src="{{asset('images/timeline/timeline-1.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2002</span></div><img src="{{asset('images/timeline/timeline-2.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2004</span></div><img src="{{asset('images/timeline/timeline-3.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2008</span></div><img src="{{asset('images/timeline/timeline-4.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2012</span></div><img src="{{asset('images/timeline/timeline-5.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2016</span></div><img src="{{asset('images/timeline/timeline-6.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                        <div class="timeline-item item swin-transition">
                                            <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2017</span></div><img src="{{asset('images/timeline/timeline-7.jpg')}}" alt="fooday" class="img img-responsive">
                                        </div>
                                    </div>
                                </div>
